<template>
    <div class="flex justify-center items-center">
        <form class="space-y-8 border-solid max-w-xl w-full mt-12" action="#" method="POST" @submit.prevent="createProduct">
            <div>
                <label for="name" class="block text-md font-medium leading-6 text-gray-900">Create new
                    product</label>
                <div class="mt-2">
            ...
            <div>
                <div class="flex items-center justify-between">
                    <label for="category" class="block text-md font-medium leading-6 text-gray-900">Create new
                        description</label>
            ...
            <div class="flex justify-end">
                ...
                <button
                    class="max-w-xs ml-2 rounded-md bg-green-600 px-3 py-1.5 text-md font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create
                </button>
